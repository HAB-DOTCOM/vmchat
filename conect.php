...
<head>
    ...
    <script
          ...
          <script type="text/javascript">
              const conn = new WebSocket('ws://localhost:8087/?token=<?php echo $userObj->sessionID; ?>')
          </script>
    <!-- Jquery timer -->
...
<div id="profile" class="flex flex-1 justify-center items-center">
    <div class="flex flex-col flex-1 h-full overflow-hidden overflow-y-auto items-center justify-center">
        ...
        <div class="right-heading">
            ...
            <button id="callBtn" data-user="<?php echo $profileData->id ?>" class="active:-top-2 relative transition border border-gray-400 shadow-md my-4 bg-green-400 hover:bg-green-500 p-4 px-5 rounded-full text-white text-xl"><i class="fas fa-video"></i></button>
        </div>
    </div>
</div>
<!--PROFILE_SECTION_END-->  
